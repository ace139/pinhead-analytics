...
client: 'Major Investment Bank' # Extracted from content
services: ['AI Strategy', 'LLM Development', 'Risk Management'] # Placeholder - to be refined
image: # Placeholder
  src: 'https://placehold.co/600x400/171717/FFF?text=Financial+Risk+AI' # Placeholder
  alt: 'AI analyzing financial data' # Placeholder
---
